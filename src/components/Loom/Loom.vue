...
// Reference with string in "is"-component only once you register it in Component (not the case in script setup) https://stackoverflow.com/questions/69237991/vue-script-setup-how-to-deal-with-multiple-dynamic-components
// alternative 1: Global Registration: https://vuejs.org/guide/components/registration.html#global-registration
// alternative 2: Dynamic mapping function https://github.com/vuejs/rfcs/blob/master/active-rfcs/0040-script-setup.md#using-components or https://stackoverflow.com/questions/69237991/vue-script-setup-how-to-deal-with-multiple-dynamic-components
// import DOTGraph from "@/components/taskComponents/DOTGraph/DOTGraph.vue";

const props = defineProps<{ storeObject: { getProperty: Function; setProperty: Function; store: object } }>();

const { getProperty, setProperty, store } = unref(props).storeObject;
...
interjectionHandler(props.storeObject as any, interjections, interjectionPath);
